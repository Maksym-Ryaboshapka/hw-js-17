...
var _renderImagesJs = require("./render-images.js");

},{"./render-images.js":"fMOeZ"}],"fMOeZ":[function(require,module,exports,__globalThis) {
var _getImagesApi = require("./services/get-images-api");
class Page {
    static renderImages() {
...
},{"./services/get-images-api":"jPN0t"}],"jPN0t":[function(require,module,exports,__globalThis) {
...
class Images {
    ...
    static getImages() {
        const API = `https://pixabay.com/api?key=${this.#API_KEY}&q=forest&callback=callbackFunction&page=${this.page}&per_page=${this.perPage}`;
